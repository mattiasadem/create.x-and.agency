          ...
          <div className="p-4 space-y-4">
                  ...
                  <button
                    ...
                    className={`
                      ...
                      ${selectedStyle === style.id
                        ...
                        : 'border-border/50 hover:border-border bg-surface text-gray-400'
                      }
            ...
            <div>
              ...
              <select
                ...
                disabled={disabled}
                className="w-full px-3 py-2 text-xs font-medium text-gray-300 bg-surface rounded border border-border focus:border-primary focus:outline-none"
              >
                {models.map((model) => (
            ...
            <div>
              <label className="block text-xs font-medium text-gray-400 mb-2">Additional Instructions (optional)</label>
              <input
                type="text"
                value={additionalInstructions}
                onChange={(e) => setAdditionalInstructions(e.target.value)}
                disabled={disabled}
                className="w-full px-3 py-2 text-xs text-gray-300 bg-surface rounded border border-border focus:border-primary focus:outline-none placeholder:text-gray-600"
            ...
            <div className="pt-2">
              <button
                ...
                className={`
                  ...
                  ${isValidUrl && !disabled
                    ? 'bg-primary hover:bg-primary/90 text-black shadow-[0_0_10px_rgba(6,182,212,0.3)]'
